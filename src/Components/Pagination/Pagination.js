...
const Pagination = (props) => {
  ...
  pages.push(
    ...
    >
      <i style={{color:"orange"}} className="fas fa-angle-double-left"></i>
    </div>
  );
  ...
  pages.push(
    ...
    >
      <i style={{color:"black"}} className="fas fa-angle-left"></i>
    </div>
  );
  ...
  pages.push(
    <div
      ...
      onClick={() => navigatePage(page + 1)}
    >
      <i style={{color:"black"}} className="fas fa-angle-right"></i>
    </div>
  );
  ...
  pages.push(
    ...
    >
      <i style={{color:"orange"}} className="fas fa-angle-double-right"></i>
    </div>
  );
